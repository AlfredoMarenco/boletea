<div x-data="{open:false}" class=" bg-white border-b-2 border-rojo">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <nav class="hidden md:flex space-x-10">
                <a href="{{ route('index') }}" class="text-base text-black font-semibold hover:text-rojo">
                    Inicio
                </a>
                <a href="{{ route('about') }}" class="text-base text-black font-semibold hover:text-rojo">
                    Quiénes Somos
                </a>
                {{-- <a href="#" class="text-base text-black font-semibold hover:text-rojo">
                    Contáctanos
                </a> --}}
                <a href="{{ route('conditions') }}" class="text-base text-black font-semibold hover:text-rojo">
                    Terminos y condiciones
                </a>
                <a href="{{ route('privacity') }}" class="text-base text-black font-semibold hover:text-rojo">
                    Aviso de privacidad
                </a>
                <a href="#" class="text-base text-black font-semibold hover:text-rojo">
                    Centros de ventas
            ...
            <div class="pt-5 pb-6 px-5">
                ...
                <div class="mt-1">
                    <nav class="grid gap-y-8">
                        ...
                        <a href="{{ route('conditions') }}" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                        ...
                        <a href="{{ route('privacity') }}" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                            <svg class="flex-shrink-0 h-6 w-6 text-rojo" xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
