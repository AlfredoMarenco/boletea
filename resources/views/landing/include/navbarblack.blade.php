            ...
            <div class="pt-5 pb-6 px-5">
                ...
                <div class="mt-1">
                    <nav class="grid gap-y-8">
                        <a href="{{ route('index') }}" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                        ...
                        <a href="{{ route('cdvs') }}" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                            <svg class="flex-shrink-0 h-6 w-6 text-rojo" xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
