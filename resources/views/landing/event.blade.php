    ...
    @foreach ($event->performances as $performance)
        <div class="grid md:grid-cols-3 gap-6 items-center bg-white my-12 mx-4 md:mx-44 py-3 shadow-md"
            ...
            <div class="col-span-3 md:col-span-1">
                <img class="w-full mx-auto md:ml-4 rounded-md"
                    src="{{ Storage::url($event->performances->count() > 1 ? $performance->image_url : $event->image_url) }}"
                    alt="">
            ...
            <div class="col-span-2 p-4 mt-1 text-center md:text-left">
                ...
                @endif
                <p class="font-semibold text-gray-800 my-2 md:my-4"><i
                        class="far fa-calendar text-2xl text-center mr-3"></i>
                    <span>{{ $carbon->parse($performance->date_start)->translatedFormat('l j \\de F Y') }} | {{ $carbon->parse($performance->time_start)->format('H:m a') }}</span>
                </p>
                <p class="font-semibold text-gray-800 mb-2 md:mb-4"><i
                        class="fab fa-fort-awesome text-2xl text-center mr-3"></i>
                    <span>{{ $performance->enclosure->name }}</span>
                </p>
                <p class="font-semibold text-gray-800 mb-2 md:mb-4"><i
                ...
                <div class="md:flex items-center justify-around">
                    ...
                    <div class="mx-4 px-1">
                        @switch($performance->enclosure->city)
                            @case('Coahuila')
