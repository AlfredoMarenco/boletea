            ...
            switch($event->lugar) {
                case 'coahuila':
                    $centrosDeVenta = [
                        ...
                        ['img' => asset('cdvs/imgCintilloLos3garcia.png'), 'alt' => 'Los 3 Garcia', 'title' => 'Suc. Fco. I. Madero, Suc. San Pedro'],
                        ['img' => asset('cdvs/cdvVaqueroNorteño.png'), 'alt' => 'Vaquero Norteño', 'title' => 'Paseo Durango'],
                    ];
                    break;
                case 'coahuila2':
                    $centrosDeVenta = [
                ...
                case 'campeche':
                    $centrosDeVenta = [
                        ['img' => asset('cdvs/logoHolidayInn.png'), 'alt' => 'Holiday Inn'],
                    ];
                    break;
                case 'quintanaroo':
                    $centrosDeVenta = [
                        ['img' => asset('cdvs/logo-bomssa.png'), 'alt' => 'Bomssa'],
                    ];
                    break;
                case 'yucatan':
                    $centrosDeVenta = [
            ...
            <div class="flex overflow-x-auto space-x-4 pb-4 hide-scrollbar">
                @foreach($centrosDeVenta as $centro)
                    <div class="flex-shrink-0 w-28 h-20 rounded-lg border border-gray-300 hover:border-rojo transition cursor-pointer flex items-center justify-center bg-white shadow-sm"
                        ...
                        <img src="{{ $centro['img'] }}" alt="{{ $centro['alt'] }}" class="object-contain max-h-16 p-2">
                    </div>
                @endforeach
            </div>
        @endif
        ...
        @if($userRegion !== 'coahuila')
            <div class="block md:hidden mt-8 p-4 border border-gray-200 rounded-lg shadow-sm bg-gray-50">
                ...
                <ins class="adsbygoogle"
                    style="display:block"
                    data-ad-client="ca-pub-5976709800052610"
                    data-ad-slot="1210961234"
                    data-ad-format="auto"
