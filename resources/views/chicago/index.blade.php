    ...
    <section>
        ...
        <div
            ...
            @forelse ($events as $event)
                <div
                    class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 col-span-4 md:col-span-1 rounded-lg border bg-gray-600 border-yellow-300 shadow-lg">
                    <a href="{{ route('showEvent', $event) }}">
                        ...
                        <div class="grid grid-cols-1 place-content-end mt-4">
                            ...
                            <div class="px-2 md:ml-3 col-span-2 text-left">
                                ...
                                <h3 class="font-bold text-lg mb-2 text-white">{{ Str::limit($event->title, 100, '...') }}</h3>
                                {{-- <h3 class="font-semibold text-sm"><i class="fab fa-fort-awesome text-center"></i> {{ $event->recinto }}</h3> --}}
                                <p class="font-semibold text-sm mb-2 text-white"><i class="fas fa-map-marker-alt mr-1 text-rojo"></i>
                                    {{ $event->ciudad }}</p>
