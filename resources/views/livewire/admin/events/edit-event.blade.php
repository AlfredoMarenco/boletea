<div>
    ...
    <form wire:submit.prevent="update" class="p-4">
        <div class="mb-4">
            <label for="name" class="block text-gray-700 mb-2">Venue Name <span
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model="slug" class="w-full border-gray-300 rounded-md py-1 bg-gray-200"
                disabled>
            @error('slug')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        ...
        <div class="mb-4">
            <label for="address" class="block text-gray-700 mb-2">Address <span
                    class="text-red-600">*</span></label>
        ...
        <div class="flex gap-4 justify-end">
            ...
            <button type="submit" class="px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600">Update
                Venue</button>
        </div>
    </form>
</div>
