<div id="eventos">
    ...
    <!-- Grid de eventos -->
    <div
        class="bg-gray-100 py-4 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-2 md:gap-2 lg:gap-8 xl:gap-8 px-4 md:px-16 mb-12 items-stretch">
