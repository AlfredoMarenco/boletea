        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="text-center">
                    @if ($message == 'VALIDO')
                        <div>
                            <p class="text-5xl text-green-600 font-bold">CUPONERA VALIDO</p>
                        </div>
                    @endif
                    @if ($message == 'ESCANEADO')
                        <div>
                            <p class="text-5xl text-red-600 font-bold">CUPONERA YA CANJEADA</p>
            ...
            <div class="text-center bg-white overflow-hidden shadow-xl sm:rounded-lg mt-4 p-2">
                <p class="font-bold">Cuponeras entregadas: {{ $scanning->count() }}</p>
            </div>
        </div>
    </div>
</div>
